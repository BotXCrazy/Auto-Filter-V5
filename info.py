...
BOT_TOKEN = environ.get('BOT_TOKEN', "5511128564:AAEMU24mwDunOSlDwxol3xa11KMoJ1vGsmw")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<Asmovies204>:<Anshuu12>@cluster0.izecre3.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Asfiles")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/TG_UPDATES_204')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001600218127))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001600218127))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/TG_UPDATES_204')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/cynitemovies/3')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001851773945))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001851773945))
...
# Delete Time
DELETE_TIME = int(environ.get('DELETE_TIME', 3000000000000000000))
SPL_DELETE_TIME = int(environ.get('SPL_DELETE_TIME', 1000000000005))

# URL SHORTNER

URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'shorturllink.in')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'c63fdc34abc491d70d04b34914a87db66436868c')
